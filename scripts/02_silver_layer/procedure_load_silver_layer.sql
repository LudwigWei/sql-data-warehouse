...
Script Purpose:
    ...
    Each table is truncated and reloaded with cleansed, standardised, and
    normalised data, following the Medallion Architecture.
...
BEGIN
	...
	BEGIN CATCH
		PRINT '=========================================================';
		PRINT 'ERROR OCCURED DURING THE LOADING OF THE SILVER LAYER...';
